...
using Nover.DB.WebView2.NativeHosts;
using Nover.DB.WebView2.Network;

namespace Nover.DB.WebView2.Browser
{
    public partial class BrowserWindow : IWebView2, IBrowserWindow, IDisposable
    {
        ...
        public async Task InitCoreWebView2Async(IntPtr hostHandle)
        {
            ...
            webView2._coreWebView2Environment = await CoreWebView2Environment.CreateAsync(creationOption.BrowserExecutableFolder, creationOption.UserDataFolder, webView2._resourceRequestHandler.EnvironmentOptions);
