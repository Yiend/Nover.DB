...
namespace Nover.DB.WebView2
{
    public static class WebView2Loader
    {
        ...
        private const string win_x86ResourcePath = "Nover.DB.WebView2.runtimes.winX86.native";
        private const string win_x64ResourcePath = "Nover.DB.WebView2.runtimes.winX64.native";
        private const string win_arm64ResourcePath = "Nover.DB.WebView2.runtimes.winArm64.native";
